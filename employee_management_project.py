...
con = mysql.connector.connect(
    host="localhost", user="root", password="Shiva@1878", database="employee")#password="Pavan@1309"
...
def Update_Employ():
    ...
    # query to update Employee (empdata) Table
    # sql='update empdata set id='&id' where id=:old.id'
    Id = input("Enter Employee Id: ")
    # checking If Employee Id is Exit Or Not
